...
export default class Environment {
     ...
     * @param {ServiceContext} service Service instance.
     */
    ...
    get path(): string {
        return join(
            this.service.serviceDirectory,
            `${this.service.selectedEnvironmentName}.env`,
        );
    }
     ...
     */
    createDotEnv = (): void => {
        const dotenvPath = join(this.service.serviceDirectory, '.env');
        this.create();
